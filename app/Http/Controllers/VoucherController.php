...
class VoucherController extends Controller
{
    ...
    {
        $voucher1 = Voucher::where('status', '=', '1')->where('semester', '=', '2')->where('schlyear', '=', '2025-2026')->get();
        $voucher2 = Voucher::where('status', '=', '0')->where('semester', '=', '2')->where('schlyear', '=', '2025-2026')->get();
